...
def euler_rotation(delta_x):
    ...
    rotation_1 = np.array([
        [np.cos(alpha), -np.sin(alpha), alpha * 0],
        [np.sin(alpha), np.cos(alpha), alpha * 0],
        [alpha * 0, alpha * 0, alpha * 1]])
    rotation_2 = np.array([
        [np.cos(beta), beta * 0, - np.sin(beta)],
        [beta * 0, beta * 1, beta * 0],
        [np.sin(beta), beta * 0, np.cos(beta)]])
    rotation_3 = np.array([
        [np.cos(gamma), -np.sin(gamma), gamma * 0],
        [np.sin(gamma), np.cos(gamma), gamma * 0],
